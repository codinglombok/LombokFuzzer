...
exports.MobileFuzzer = exports.ReactNativeHarness = exports.IOSHarness = exports.AndroidHarness = exports.MobilePlatform = void 0;
...
class AndroidHarness {
    ...
    parseLogcat(logcat) {
        ...
        return {
            ...
            severity: signal === 'SIGSEGV' || signal === 'SIGABRT' ? types_js_1.Severity.Critical : types_js_1.Severity.High,
        };
    }
...
exports.AndroidHarness = AndroidHarness;
// ─── iOS Harness ────────────────────────────────────────────────────────────
class IOSHarness {
    kind = 'mobile';
    config;
...
exports.ReactNativeHarness = ReactNativeHarness;
...
exports.MobileFuzzer = MobileFuzzer;
// ─── Helpers ────────────────────────────────────────────────────────────────
function hrtimeUs() {
...
function signalToCwe(signal) {
    switch (signal) {
        case 'SIGSEGV': return types_js_1.CrashCategory.NullDeref;
        case 'SIGABRT': return types_js_1.CrashCategory.Assertion;
        case 'SIGBUS': return types_js_1.CrashCategory.BufferOverflow;
        case 'SIGFPE': return types_js_1.CrashCategory.DivisionByZero;
        case 'SIGILL': return types_js_1.CrashCategory.Unknown;
        case 'EXC_BAD_ACCESS': return types_js_1.CrashCategory.NullDeref;
        case 'EXC_BAD_INSTRUCTION': return types_js_1.CrashCategory.Unknown;
        case 'JAVA_EXCEPTION': return types_js_1.CrashCategory.Unknown;
        default: return types_js_1.CrashCategory.Unknown;
    }
}
