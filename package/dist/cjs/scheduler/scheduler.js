...
class Scheduler {
    ...
    select(corpus, stats) {
        ...
        switch (this.config.algorithm) {
            case types_js_1.SchedulerAlgorithm.RoundRobin:
                return this.roundRobin(corpus);
            case types_js_1.SchedulerAlgorithm.AFLFast:
                return this.aflFast(corpus);
            case types_js_1.SchedulerAlgorithm.MAB:
                return this.mab(corpus);
            case types_js_1.SchedulerAlgorithm.RareBranch:
                return this.rareBranch(corpus, stats);
            case types_js_1.SchedulerAlgorithm.EcoFuzz:
                return this.ecoFuzz(corpus, stats);
            case types_js_1.SchedulerAlgorithm.Entropic:
                return this.entropic(corpus);
            case types_js_1.SchedulerAlgorithm.Custom:
