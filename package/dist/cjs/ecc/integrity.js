...
class EccIntegrity {
    ...
    async init() {
        ...
        try {
            ...
            this.eccModule = await Promise.resolve(`${'lombokecc'}`).then(s => __importStar(require(s)));
    ...
    verify(blob) {
        if (!this.isEccBlob(blob))
            return IntegrityStatus.Unprotected;
...
exports.EccIntegrity = EccIntegrity;
