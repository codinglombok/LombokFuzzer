...
exports.GrammarEngine = exports.NodeKind = void 0;
// ─── Grammar AST ────────────────────────────────────────────────────────────
var NodeKind;
(function (NodeKind) {
    NodeKind["Literal"] = "literal";
    NodeKind["CharRange"] = "char_range";
...
class GrammarEngine {
    ...
    maxDepth;
    maxLength;
    constructor(prng, maxDepth = 20, maxLength = 65536) {
        this.prng = prng;
    ...
    mutateGrammarInput(input, grammar) {
...
function weightedPick(items, weights, prng) {
    let total = 0;
