...
<header>
  <h1>🐛 ${esc(name)}</h1>
  <p>Execution ${esc(s?.executionId ?? '—')} · Elapsed ${formatDuration(s?.elapsedMs ?? 0)} · LombokFuzzer v${index_js_1.VERSION}</p>
</header>
...
<footer>
  Generated by LombokFuzzer v${index_js_1.VERSION} · LombokCSS + LombokCharts
</footer>
