...
exports.ReporterRegistry = exports.CiReporter = exports.HtmlReporter = exports.JsonReporter = exports.ConsoleReporter = void 0;
...
class CiReporter {
    ...
    onCrash(crash) {
        if (this.platform === 'github') {
            const level = crash.severity === types_js_1.Severity.Critical || crash.severity === types_js_1.Severity.High
                ? 'error' : 'warning';
