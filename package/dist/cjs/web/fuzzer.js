...
exports.WebFuzzer = exports.HEADER_INJECTION_PAYLOADS = exports.WebVulnerability = void 0;
var WebVulnerability;
(function (WebVulnerability) {
    WebVulnerability["ReflectedXSS"] = "reflected_xss";
    WebVulnerability["StoredXSS"] = "stored_xss";
    WebVulnerability["DOMXSS"] = "dom_xss";
    WebVulnerability["CSRFMissing"] = "csrf_missing";
    WebVulnerability["CORSMisconfig"] = "cors_misconfiguration";
    WebVulnerability["CSPBypass"] = "csp_bypass";
    WebVulnerability["OpenRedirect"] = "open_redirect";
    WebVulnerability["HeaderInjection"] = "header_injection";
    WebVulnerability["CookieInsecure"] = "insecure_cookie";
    WebVulnerability["SessionFixation"] = "session_fixation";
    WebVulnerability["Clickjacking"] = "clickjacking";
    WebVulnerability["MIME_Sniffing"] = "mime_sniffing";
    WebVulnerability["InfoLeak"] = "information_leak";
})(WebVulnerability || (exports.WebVulnerability = WebVulnerability = {}));
// ─── Payload Libraries ──────────────────────────────────────────────────────
const XSS_PAYLOADS = [
...
exports.HEADER_INJECTION_PAYLOADS = [
    ...
    analyzeCookies(url, cookies) {
        ...
        for (const cookie of cookies) {
            ...
            if (!cookie.sameSite || cookie.sameSite === 'None')
                issues.push('SameSite=None or missing');
            if (issues.length > 0) {
                found.push({
