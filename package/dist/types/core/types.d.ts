...
export declare enum CrashCategory {
...
export declare enum MutatorStrategy {
    BitFlip = "bit_flip",
    ByteFlip = "byte_flip",
...
export declare enum SchedulerAlgorithm {
...
export declare enum HarnessMode {
...
export declare enum CoverageMetric {
    Edge = "edge",
    Branch = "branch",
    Path = "path",
    Line = "line",
...
export interface FuzzEventMap {
    ...
    [FuzzEvent.InputGenerated]: {
        input: FuzzInput;
    };
    [FuzzEvent.InputExecuted]: {
        result: ExecutionResult;
    };
    [FuzzEvent.NewCoverage]: {
        result: ExecutionResult;
        newEdgeCount: number;
    };
    [FuzzEvent.CrashFound]: {
        crash: CrashInfo;
    };
    [FuzzEvent.TimeoutFound]: {
        input: FuzzInput;
        durationUs: number;
    };
    [FuzzEvent.CrashMinimized]: {
        crash: CrashInfo;
        originalSize: number;
        minimizedSize: number;
    };
    [FuzzEvent.CorpusUpdated]: {
        corpusSize: number;
        addedHash: CorpusHash;
    };
    [FuzzEvent.StatsUpdated]: {
        stats: FuzzStats;
    };
    [FuzzEvent.PhaseChanged]: {
        phase: string;
        reason: string;
    };
    [FuzzEvent.Paused]: {
